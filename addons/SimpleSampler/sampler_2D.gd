...
func play_note(note: String, octave: int = 4, velocity : int = 5):
	...
	_play_note(matching_samples, note, octave, velocity)


func _play_note(matching_samples: Array[NoteSample], note: String, octave: int = 4, velocity : int = 5):
